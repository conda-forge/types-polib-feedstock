...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-polib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13149&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-polib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-polib` can be installed with:

```
conda install types-polib
```

It is possible to list all of the versions of `types-polib` available on your platform with:
